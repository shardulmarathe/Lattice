    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            <h2 className="text-xl tracking-[0.35em] text-white">PAUSED</h2>

            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              onClick={onResume}
              className="w-full border border-white/20 py-3 text-sm tracking-[0.2em] text-white transition-colors hover:border-[#FF2D2D]/50"
            >
              RESUME
            </motion.button>
          </motion.div>
